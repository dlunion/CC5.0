...
namespace protobuf_tensorboardX_2fproto_2fversions_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorboardX/proto/versions.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n!tensorboardX/proto/versions.proto\022\014ten"
      "sorboardX\"K\n\nVersionDef\022\020\n\010producer\030\001 \001("
      "\005\022\024\n\014min_consumer\030\002 \001(\005\022\025\n\rbad_consumers"
      "\030\003 \003(\005B/\n\030org.tensorflow.frameworkB\016Vers"
      "ionsProtosP\001\370\001\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 183);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tensorboardX/proto/versions.proto", &protobuf_RegisterTypes);
...
VersionDef::VersionDef()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensorboardX_2fproto_2fversions_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:tensorboardX.VersionDef)
}
VersionDef::VersionDef(::google::protobuf::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:tensorboardX.VersionDef)
}
VersionDef::VersionDef(const VersionDef& from)
  ...
  // @@protoc_insertion_point(copy_constructor:tensorboardX.VersionDef)
}
...
VersionDef::~VersionDef() {
  // @@protoc_insertion_point(destructor:tensorboardX.VersionDef)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* VersionDef::descriptor() {
  protobuf_tensorboardX_2fproto_2fversions_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorboardX_2fproto_2fversions_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:tensorboardX.VersionDef)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:tensorboardX.VersionDef)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:tensorboardX.VersionDef)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tensorboardX.VersionDef)
  return false;
#undef DO_
}
...
void VersionDef::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:tensorboardX.VersionDef)
  ...
  // @@protoc_insertion_point(serialize_end:tensorboardX.VersionDef)
}

::google::protobuf::uint8* VersionDef::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:tensorboardX.VersionDef)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tensorboardX.VersionDef)
  return target;
}

size_t VersionDef::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tensorboardX.VersionDef)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:tensorboardX.VersionDef)
  GOOGLE_DCHECK_NE(&from, this);
  const VersionDef* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const VersionDef>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tensorboardX.VersionDef)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tensorboardX.VersionDef)
    MergeFrom(*source);
  }
}

void VersionDef::MergeFrom(const VersionDef& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tensorboardX.VersionDef)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:tensorboardX.VersionDef)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:tensorboardX.VersionDef)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata VersionDef::GetMetadata() const {
  protobuf_tensorboardX_2fproto_2fversions_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorboardX_2fproto_2fversions_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
::google::protobuf::int32 VersionDef::producer() const {
  // @@protoc_insertion_point(field_get:tensorboardX.VersionDef.producer)
  return producer_;
}
void VersionDef::set_producer(::google::protobuf::int32 value) {
  
  producer_ = value;
  // @@protoc_insertion_point(field_set:tensorboardX.VersionDef.producer)
}
...
::google::protobuf::int32 VersionDef::min_consumer() const {
  // @@protoc_insertion_point(field_get:tensorboardX.VersionDef.min_consumer)
  return min_consumer_;
}
void VersionDef::set_min_consumer(::google::protobuf::int32 value) {
  
  min_consumer_ = value;
  // @@protoc_insertion_point(field_set:tensorboardX.VersionDef.min_consumer)
}
...
::google::protobuf::int32 VersionDef::bad_consumers(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.VersionDef.bad_consumers)
...
void VersionDef::set_bad_consumers(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:tensorboardX.VersionDef.bad_consumers)
}
void VersionDef::add_bad_consumers(::google::protobuf::int32 value) {
  bad_consumers_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.VersionDef.bad_consumers)
}
const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
VersionDef::bad_consumers() const {
  // @@protoc_insertion_point(field_list:tensorboardX.VersionDef.bad_consumers)
  return bad_consumers_;
}
::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
VersionDef::mutable_bad_consumers() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.VersionDef.bad_consumers)
  return &bad_consumers_;
}
