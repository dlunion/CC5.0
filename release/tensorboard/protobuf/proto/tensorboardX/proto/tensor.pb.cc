...
namespace protobuf_tensorboardX_2fproto_2ftensor_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorboardX/proto/tensor.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::tensorboardX::protobuf_tensorboardX_2fproto_2fresource_5fhandle_2eproto::InitDefaults();
  ...
  _TensorProto_default_instance_.get_mutable()->tensor_shape_ = const_cast< ::tensorboardX::TensorShapeProto*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n\037tensorboardX/proto/tensor.proto\022\014tenso"
      "rboardX\032(tensorboardX/proto/resource_han"
      "dle.proto\032%tensorboardX/proto/tensor_sha"
      "pe.proto\032\036tensorboardX/proto/types.proto"
      "\"\251\003\n\013TensorProto\022%\n\005dtype\030\001 \001(\0162\026.tensor"
      "boardX.DataType\0224\n\014tensor_shape\030\002 \001(\0132\036."
      "tensorboardX.TensorShapeProto\022\026\n\016version"
      "_number\030\003 \001(\005\022\026\n\016tensor_content\030\004 \001(\014\022\024\n"
      "\010half_val\030\r \003(\005B\002\020\001\022\025\n\tfloat_val\030\005 \003(\002B\002"
      "\020\001\022\026\n\ndouble_val\030\006 \003(\001B\002\020\001\022\023\n\007int_val\030\007 "
      "\003(\005B\002\020\001\022\022\n\nstring_val\030\010 \003(\014\022\030\n\014scomplex_"
      "val\030\t \003(\002B\002\020\001\022\025\n\tint64_val\030\n \003(\003B\002\020\001\022\024\n\010"
      "bool_val\030\013 \003(\010B\002\020\001\022\030\n\014dcomplex_val\030\014 \003(\001"
      "B\002\020\001\022>\n\023resource_handle_val\030\016 \003(\0132!.tens"
      "orboardX.ResourceHandleProtoB-\n\030org.tens"
      "orflow.frameworkB\014TensorProtosP\001\370\001\001b\006pro"
      "to3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 643);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tensorboardX/proto/tensor.proto", &protobuf_RegisterTypes);
  ::tensorboardX::protobuf_tensorboardX_2fproto_2fresource_5fhandle_2eproto::AddDescriptors();
...
void TensorProto::_slow_mutable_tensor_shape() {
  tensor_shape_ = ::google::protobuf::Arena::CreateMessage< ::tensorboardX::TensorShapeProto >(
      GetArenaNoVirtual());
}
::tensorboardX::TensorShapeProto* TensorProto::_slow_release_tensor_shape() {
  if (tensor_shape_ == NULL) {
    return NULL;
  } else {
    ::tensorboardX::TensorShapeProto* temp = new ::tensorboardX::TensorShapeProto(*tensor_shape_);
    tensor_shape_ = NULL;
    return temp;
  }
}
::tensorboardX::TensorShapeProto* TensorProto::unsafe_arena_release_tensor_shape() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorboardX.TensorProto.tensor_shape)
  
  ::tensorboardX::TensorShapeProto* temp = tensor_shape_;
  tensor_shape_ = NULL;
  return temp;
}
void TensorProto::_slow_set_allocated_tensor_shape(
    ::google::protobuf::Arena* message_arena, ::tensorboardX::TensorShapeProto** tensor_shape) {
    if (message_arena != NULL && 
      ...
      ::tensorboardX::TensorShapeProto* new_tensor_shape = 
...
void TensorProto::unsafe_arena_set_allocated_tensor_shape(
    ::tensorboardX::TensorShapeProto* tensor_shape) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorboardX.TensorProto.tensor_shape)
}
...
TensorProto::TensorProto()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensorboardX_2fproto_2ftensor_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:tensorboardX.TensorProto)
}
TensorProto::TensorProto(::google::protobuf::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:tensorboardX.TensorProto)
}
TensorProto::TensorProto(const TensorProto& from)
  ...
  if (from.has_tensor_shape()) {
    tensor_shape_ = new ::tensorboardX::TensorShapeProto(*from.tensor_shape_);
  } else {
    tensor_shape_ = NULL;
  }
  ...
  // @@protoc_insertion_point(copy_constructor:tensorboardX.TensorProto)
}
...
TensorProto::~TensorProto() {
  // @@protoc_insertion_point(destructor:tensorboardX.TensorProto)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* TensorProto::descriptor() {
  protobuf_tensorboardX_2fproto_2ftensor_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorboardX_2fproto_2ftensor_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:tensorboardX.TensorProto)
  float_val_.Clear();
  double_val_.Clear();
  int_val_.Clear();
  string_val_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:tensorboardX.TensorProto)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // .tensorboardX.DataType dtype = 1;
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_dtype(static_cast< ::tensorboardX::DataType >(value));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      // .tensorboardX.TensorShapeProto tensor_shape = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
      ...
      // repeated .tensorboardX.ResourceHandleProto resource_handle_val = 14;
      case 14: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
success:
  // @@protoc_insertion_point(parse_success:tensorboardX.TensorProto)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tensorboardX.TensorProto)
  return false;
#undef DO_
}
...
void TensorProto::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:tensorboardX.TensorProto)
  ...
  // @@protoc_insertion_point(serialize_end:tensorboardX.TensorProto)
}

::google::protobuf::uint8* TensorProto::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:tensorboardX.TensorProto)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tensorboardX.TensorProto)
  return target;
}

size_t TensorProto::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tensorboardX.TensorProto)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:tensorboardX.TensorProto)
  GOOGLE_DCHECK_NE(&from, this);
  const TensorProto* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const TensorProto>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tensorboardX.TensorProto)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tensorboardX.TensorProto)
    MergeFrom(*source);
  }
}

void TensorProto::MergeFrom(const TensorProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tensorboardX.TensorProto)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_tensor_shape()) {
    mutable_tensor_shape()->::tensorboardX::TensorShapeProto::MergeFrom(from.tensor_shape());
  }
  if (from.dtype() != 0) {
...
// @@protoc_insertion_point(generalized_copy_from_start:tensorboardX.TensorProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:tensorboardX.TensorProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata TensorProto::GetMetadata() const {
  protobuf_tensorboardX_2fproto_2ftensor_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorboardX_2fproto_2ftensor_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
::tensorboardX::DataType TensorProto::dtype() const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.dtype)
  return static_cast< ::tensorboardX::DataType >(dtype_);
}
void TensorProto::set_dtype(::tensorboardX::DataType value) {
  
  dtype_ = value;
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.dtype)
}
...
const ::tensorboardX::TensorShapeProto& TensorProto::tensor_shape() const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.tensor_shape)
  return tensor_shape_ != NULL ? *tensor_shape_
                         : *::tensorboardX::TensorShapeProto::internal_default_instance();
}
::tensorboardX::TensorShapeProto* TensorProto::mutable_tensor_shape() {
  
  if (tensor_shape_ == NULL) {
    _slow_mutable_tensor_shape();
  }
  // @@protoc_insertion_point(field_mutable:tensorboardX.TensorProto.tensor_shape)
  return tensor_shape_;
}
::tensorboardX::TensorShapeProto* TensorProto::release_tensor_shape() {
  // @@protoc_insertion_point(field_release:tensorboardX.TensorProto.tensor_shape)
 ...
 void TensorProto::set_allocated_tensor_shape(::tensorboardX::TensorShapeProto* tensor_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorboardX.TensorProto.tensor_shape)
}
...
::google::protobuf::int32 TensorProto::version_number() const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.version_number)
  return version_number_;
}
void TensorProto::set_version_number(::google::protobuf::int32 value) {
  
  version_number_ = value;
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.version_number)
}
...
const ::std::string& TensorProto::tensor_content() const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.tensor_content)
...
void TensorProto::set_tensor_content(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.tensor_content)
}
void TensorProto::set_tensor_content(const char* value) {
  ...
  tensor_content_.Set(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:tensorboardX.TensorProto.tensor_content)
}
void TensorProto::set_tensor_content(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:tensorboardX.TensorProto.tensor_content)
}
::std::string* TensorProto::mutable_tensor_content() {
  
  // @@protoc_insertion_point(field_mutable:tensorboardX.TensorProto.tensor_content)
...
::std::string* TensorProto::release_tensor_content() {
  // @@protoc_insertion_point(field_release:tensorboardX.TensorProto.tensor_content)
...
::std::string* TensorProto::unsafe_arena_release_tensor_content() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorboardX.TensorProto.tensor_content)
...
void TensorProto::set_allocated_tensor_content(::std::string* tensor_content) {
  ...
  tensor_content_.SetAllocated(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tensor_content,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:tensorboardX.TensorProto.tensor_content)
}
void TensorProto::unsafe_arena_set_allocated_tensor_content(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorboardX.TensorProto.tensor_content)
}
...
::google::protobuf::int32 TensorProto::half_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.half_val)
  return half_val_.Get(index);
}
void TensorProto::set_half_val(int index, ::google::protobuf::int32 value) {
  half_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.half_val)
}
void TensorProto::add_half_val(::google::protobuf::int32 value) {
  half_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.half_val)
}
const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
TensorProto::half_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.half_val)
  return half_val_;
}
::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
TensorProto::mutable_half_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.half_val)
  return &half_val_;
}
...
float TensorProto::float_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.float_val)
  return float_val_.Get(index);
}
void TensorProto::set_float_val(int index, float value) {
  float_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.float_val)
}
void TensorProto::add_float_val(float value) {
  float_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.float_val)
}
const ::google::protobuf::RepeatedField< float >&
TensorProto::float_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.float_val)
  return float_val_;
}
::google::protobuf::RepeatedField< float >*
TensorProto::mutable_float_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.float_val)
  return &float_val_;
}
...
double TensorProto::double_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.double_val)
  return double_val_.Get(index);
}
void TensorProto::set_double_val(int index, double value) {
  double_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.double_val)
}
void TensorProto::add_double_val(double value) {
  double_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.double_val)
}
const ::google::protobuf::RepeatedField< double >&
TensorProto::double_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.double_val)
  return double_val_;
}
::google::protobuf::RepeatedField< double >*
TensorProto::mutable_double_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.double_val)
  return &double_val_;
}
...
::google::protobuf::int32 TensorProto::int_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.int_val)
  return int_val_.Get(index);
}
void TensorProto::set_int_val(int index, ::google::protobuf::int32 value) {
  int_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.int_val)
}
void TensorProto::add_int_val(::google::protobuf::int32 value) {
  int_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.int_val)
}
const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
TensorProto::int_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.int_val)
  return int_val_;
}
::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
TensorProto::mutable_int_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.int_val)
  return &int_val_;
}
...
const ::std::string& TensorProto::string_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.string_val)
  return string_val_.Get(index);
}
::std::string* TensorProto::mutable_string_val(int index) {
  // @@protoc_insertion_point(field_mutable:tensorboardX.TensorProto.string_val)
  return string_val_.Mutable(index);
}
void TensorProto::set_string_val(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.string_val)
...
void TensorProto::set_string_val(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  string_val_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tensorboardX.TensorProto.string_val)
}
void TensorProto::set_string_val(int index, const void* value, size_t size) {
  string_val_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorboardX.TensorProto.string_val)
}
::std::string* TensorProto::add_string_val() {
  // @@protoc_insertion_point(field_add_mutable:tensorboardX.TensorProto.string_val)
  return string_val_.Add();
}
void TensorProto::add_string_val(const ::std::string& value) {
  string_val_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.string_val)
}
#if LANG_CXX11
...
void TensorProto::add_string_val(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  string_val_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tensorboardX.TensorProto.string_val)
}
void TensorProto::add_string_val(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:tensorboardX.TensorProto.string_val)
}
const ::google::protobuf::RepeatedPtrField< ::std::string>&
TensorProto::string_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.string_val)
  return string_val_;
}
::google::protobuf::RepeatedPtrField< ::std::string>*
TensorProto::mutable_string_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.string_val)
  return &string_val_;
}
...
float TensorProto::scomplex_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.scomplex_val)
  return scomplex_val_.Get(index);
}
void TensorProto::set_scomplex_val(int index, float value) {
  scomplex_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.scomplex_val)
}
void TensorProto::add_scomplex_val(float value) {
  scomplex_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.scomplex_val)
}
const ::google::protobuf::RepeatedField< float >&
TensorProto::scomplex_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.scomplex_val)
  return scomplex_val_;
}
::google::protobuf::RepeatedField< float >*
TensorProto::mutable_scomplex_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.scomplex_val)
  return &scomplex_val_;
}
...
::google::protobuf::int64 TensorProto::int64_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.int64_val)
...
void TensorProto::set_int64_val(int index, ::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.int64_val)
}
void TensorProto::add_int64_val(::google::protobuf::int64 value) {
  int64_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.int64_val)
}
const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
TensorProto::int64_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.int64_val)
  return int64_val_;
}
::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
TensorProto::mutable_int64_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.int64_val)
  return &int64_val_;
}
...
bool TensorProto::bool_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.bool_val)
  return bool_val_.Get(index);
}
void TensorProto::set_bool_val(int index, bool value) {
  bool_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.bool_val)
}
void TensorProto::add_bool_val(bool value) {
  bool_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.bool_val)
}
const ::google::protobuf::RepeatedField< bool >&
TensorProto::bool_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.bool_val)
  return bool_val_;
}
::google::protobuf::RepeatedField< bool >*
TensorProto::mutable_bool_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.bool_val)
  return &bool_val_;
}
...
double TensorProto::dcomplex_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.dcomplex_val)
  return dcomplex_val_.Get(index);
}
void TensorProto::set_dcomplex_val(int index, double value) {
  dcomplex_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorboardX.TensorProto.dcomplex_val)
}
void TensorProto::add_dcomplex_val(double value) {
  dcomplex_val_.Add(value);
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.dcomplex_val)
}
const ::google::protobuf::RepeatedField< double >&
TensorProto::dcomplex_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.dcomplex_val)
  return dcomplex_val_;
}
::google::protobuf::RepeatedField< double >*
TensorProto::mutable_dcomplex_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.dcomplex_val)
  return &dcomplex_val_;
}
...
const ::tensorboardX::ResourceHandleProto& TensorProto::resource_handle_val(int index) const {
  // @@protoc_insertion_point(field_get:tensorboardX.TensorProto.resource_handle_val)
  return resource_handle_val_.Get(index);
}
::tensorboardX::ResourceHandleProto* TensorProto::mutable_resource_handle_val(int index) {
  // @@protoc_insertion_point(field_mutable:tensorboardX.TensorProto.resource_handle_val)
  return resource_handle_val_.Mutable(index);
}
::tensorboardX::ResourceHandleProto* TensorProto::add_resource_handle_val() {
  // @@protoc_insertion_point(field_add:tensorboardX.TensorProto.resource_handle_val)
  return resource_handle_val_.Add();
}
::google::protobuf::RepeatedPtrField< ::tensorboardX::ResourceHandleProto >*
TensorProto::mutable_resource_handle_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorboardX.TensorProto.resource_handle_val)
  return &resource_handle_val_;
}
const ::google::protobuf::RepeatedPtrField< ::tensorboardX::ResourceHandleProto >&
TensorProto::resource_handle_val() const {
  // @@protoc_insertion_point(field_list:tensorboardX.TensorProto.resource_handle_val)
  return resource_handle_val_;
}
